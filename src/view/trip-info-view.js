import { DATE_FORMAT_DAY_RESULTS } from '../const.js';
...
function createInfoTemplate({totalCount, destinations, isThree, dateStart, dateEnd}) {
  return (
    ...
    <section class="trip-main__trip-info  trip-info">
      ...
      <p class="trip-info__dates">${humanizeTaskDueDate(dateStart, DATE_FORMAT_DAY_RESULTS)}&nbsp;&mdash;&nbsp;${humanizeTaskDueDate(dateEnd, DATE_FORMAT_DAY_RESULTS)}</p>
      </div>`
      :
